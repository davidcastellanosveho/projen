...
export class GitHubActions {
  ...
  /** peter-evans/enable-pull-request-automerge at v3 */
  public static readonly PETER_EVANS_ENABLE_PULL_REQUEST_AUTOMERGE = "peter-evans/enable-pull-request-automerge@v3";
